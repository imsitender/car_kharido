...
<div class="card card-outline card-primary rounded-0 shadow-sm my-3">
    <div class="card-header rounded-0">
        <h5 class="card-title"><?= isset($id) ? "Update Product Details" : "Add New Product" ?></h5>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea rows="3" name="condition" id="condition" class="form-control form-control-border summernote" data-height = "40vh" data-placeholder="Write the car condition here."><?php echo isset($condition) ? $condition : '' ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="features" class="control-label text-dark">Features</label>
                                <textarea rows="3" name="features" id="features" class="form-control form-control-border summernote" data-height = "40vh" data-placeholder="Write the car features here." ><?php echo isset($features) ? $features : '' ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="description" class="control-label text-dark">Description/Content</label>
                                <textarea rows="3" name="description" id="description" class="form-control form-control-border summernote" data-height = "40vh" data-placeholder="Write the product description here."><?php echo isset($description) ? $description : '' ?></textarea>
                            </div>
