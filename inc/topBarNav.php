...
<!-- Navbar -->
      ...
      <nav class="bg-dark w-100 px-2 py-1 position-fixed top-0" id="login-nav">
        <div class="text-right">
          ...
          <span class="mx-2">Hello, <?= $_settings->userdata('username') ?></span>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=brands" class="nav-link <?= isset($page) && $page =='brands' ? "active" : "" ?>">Brands</a>
              </li>
              <li class="nav-item">
                <a href="./?page=about_us" class="nav-link <?= isset($page) && $page =='about_us' ? "active" : "" ?>">About</a>
              </li>
              <!-- <li class="nav-item">
