                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " name="contact" placeholder="09xxxxxxx"  onkeypress="return onlyNumberKey(event)" maxlength="10" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="message" class="control-label">Message</label>
                            <textarea name="message" id="message" class="form-control" rows="5" maxlength="500" required></textarea>
                        </div>
